...
TARGETS = [
    ...
    dict(id="ltxv", genre="Video DiT (LTX-Video 13B, VAE bundled)",
         repo="Lightricks/LTX-Video",
         file="ltxv-13b-0.9.8-dev.safetensors",
         license="LTXV Open Weights", gated=False,
         expect_kind="backbone_vae", expect_arch="ltx_video"),
    dict(id="ltxv-lora", genre="LoRA (LTX-Video, PEFT layout)",
         repo="Lightricks/LTX-Video",
         file="ltxv-13b-0.9.7-distilled-lora128.safetensors",
         license="LTXV Open Weights", gated=False,
         expect_kind="lora", expect_arch="ltx_video"),
    dict(id="cogvideox", genre="Video DiT (CogVideoX-5b)",
         repo="THUDM/CogVideoX-5b",
         file="transformer/diffusion_pytorch_model-00001-of-00002.safetensors",
         license="CogVideoX License", gated=False,
         expect_kind="unet_only", expect_arch="cogvideox"),
    dict(id="cogvideox-vae", genre="VAE (CogVideoX 3D)",
         repo="THUDM/CogVideoX-5b",
         file="vae/diffusion_pytorch_model.safetensors",
         license="CogVideoX License", gated=False,
         expect_kind="vae", expect_arch="vae_3d_16ch"),
    dict(id="sana", genre="DiT (SANA 1.6B)",
         repo="Efficient-Large-Model/Sana_1600M_1024px_diffusers",
         file="transformer/diffusion_pytorch_model.safetensors",
         license="Apache-2.0", gated=False,
         expect_kind="unet_only", expect_arch="sana"),
    dict(id="pixart-sigma", genre="DiT (PixArt-Sigma XL-2)",
         repo="PixArt-alpha/PixArt-Sigma-XL-2-1024-MS",
         file="transformer/diffusion_pytorch_model.safetensors",
         license="OpenRAIL++", gated=False,
         expect_kind="unet_only", expect_arch="pixart"),
    dict(id="auraflow", genre="DiT (AuraFlow v0.3, all-in-one)",
         repo="fal/AuraFlow-v0.3",
         file="aura_flow_0.3.safetensors",
         license="Apache-2.0", gated=False,
         expect_kind="checkpoint", expect_arch="auraflow"),
    dict(id="lumina2", genre="DiT (Lumina-Image 2.0)",
         repo="Alpha-VLLM/Lumina-Image-2.0",
         file="transformer/diffusion_pytorch_model-00001-of-00002.safetensors",
         license="Apache-2.0", gated=False,
         expect_kind="unet_only", expect_arch="lumina2"),
    dict(id="kolors-unet", genre="UNet (Kolors - SDXL-compatible, ChatGLM text encoder)",
         repo="Kwai-Kolors/Kolors",
         file="unet/diffusion_pytorch_model.fp16.safetensors",
         license="Apache-2.0", gated=False,
         # Kolors reuses the SDXL UNet and the same 2048 cross-attention width,
    ...
    dict(id="flux-vae", genre="VAE (FLUX.1 autoencoder)",
         ...
         license="Apache-2.0", gated=True,
         expect_kind="vae", expect_arch="vae_sd_2d"),
    # --- 補助モデル系（ComfyUI が models/ipadapter, clip_vision などに置くもの）---
    dict(id="ip-adapter-sd15", genre="IP-Adapter (SD1.5)",
         repo="h94/IP-Adapter",
    ...
    dict(id="t2i-adapter-sdxl", genre="T2I-Adapter (SDXL, canny)",
         ...
         file="diffusion_pytorch_model.fp16.safetensors",
         license="Apache-2.0", gated=False,
         expect_kind="t2i_adapter", expect_arch=None),
    dict(id="clip-vision-h", genre="CLIP Vision (image half only, IP-Adapter ships it)",
         repo="h94/IP-Adapter",
         file="models/image_encoder/model.safetensors",
         license="Apache-2.0", gated=False,
         expect_kind="clip_vision", expect_arch=None),
    dict(id="clip-full-openclip", genre="CLIP, both halves (open_clip layout)",
         repo="laion/CLIP-ViT-H-14-laion2B-s32B-b79K",
         file="open_clip_model.safetensors",
         license="MIT", gated=False,
         expect_kind="clip_full", expect_arch=None),
    dict(id="clip-full-transformers", genre="CLIP, both halves (transformers layout)",
         repo="laion/CLIP-ViT-H-14-laion2B-s32B-b79K",
